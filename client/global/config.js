...
var BROWSER_RESOLUTION = "1080P"; //AUTO,720P,1080P,1080I
...
var DEVICE_TYPE = "infomir1080";//exterity,infomir1080,aminocom1080,infomir720
var DEVICE_ID = 0;
var MCAST_PREFIX = "";
...
var DATETIME_URL = "http://" + top.ip + "/" + top.APPNAME + "/index.php/api/datetime/language/";
var LOCAL_DATE = true;
...
var SERVICE_GUEST_INFO = "http://" + top.ip + "/" + top.APPNAME + "/index.php/api/guestdata/";
var ALARM_ENABLED = 0;
...
var SERVICEALARM_CURRENT = "http://" + top.ip + "/" + top.APPNAME + "/index.php/api/servicealarmcurrent/";
var SERVICEALARM_REMOVE = "http://" + top.ip + "/" + top.APPNAME + "/index.php/api/servicealarmremove/";
...
var BORDER_WIDTH = 0;
var BORDER_HEIGHT = 0;
var HIDE_SLIDER = 'NO'; // YES,NO
var CHANGE_LANG_URL = "http://" + top.ip + "/" + top.APPNAME + "/index.php/api/changelang/";
var IS_DEPLOY = true;//true,false
var GLOBAL_ALARM_DATA = null;
var GLOBAL_FIRE_ALARM = 0;
var ALARM_CONTAINER = null;
var LIVE_CHANNEL = null;
var STANDBY_HOLD = false;
var CHECKED_OUT = false;
var CHECKED_OUT_FLAG = false;
var DEFAULT_GUEST_ID = 0;
var DEFAULT_THEME = "coraldubai";
var DEFAULT_GREETING = "Thank you for choosing to stay with us, we truly hope you will have a wonderful and memorable time !";
var MESSAGES_INDEX = null;
var COMMON_APP_URL = "http://" + top.ip + "/" + top.APPNAME + "/index.php/api/";
var METEOR_URL = "http://192.168.3.11:8081/Meteor/interface/istv/istv.jsp?";
