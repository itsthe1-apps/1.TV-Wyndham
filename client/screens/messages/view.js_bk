function messageListGetScreenHtml() {
    ...
    b += "</div>";
    b += '<div id="ticker_tape_messages" class="ticker_tape_messages"><div id="promotion_id">Promotions</div><p id="messages_promotion_text"></p></div>';
    b += '<div class="footer">';
...
function messageListRestListOnIndexChanged(c, i) {
    ...
    var o = parseInt(h, 10) - (parseInt(j, 10) / 2);
    var l;
    var g = this.getSelected();
    l = o + Math.floor(g % top.MSGS_ROWS) * (parseInt(n, 10) + parseInt(j, 10));
