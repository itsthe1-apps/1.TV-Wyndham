...
//$config['DX_website_name'] = 'http://www.itsthe1.com/profiles/mbcadmin_v3';
...
$config['DX_chroles_table'] = 'channel_group';
$config['DX_permissions_table'] = 'permissions';
$config['DX_chpermissions_table'] = 'channel_permissions';
$config['DX_chrolepermissions_table'] = 'channel_role_permissions';
$config['DX_stbpermissions_table'] = 'stb_permissions';
...
$config['DX_captcha_path'] = './captcha/';
//$config['DX_captcha_path'] = 'C:/Program Files/Apache Software Foundation/Apache2.2/htdocs/eticketsystem/captcha/';
$config['DX_captcha_fonts_path'] = $config['DX_captcha_path'].'fonts'; 

$config['DX_captcha_width'] = 250;
$config['DX_captcha_height'] = 45;
...
$config['DX_register_uri'] = '/MyAuth/register/';
...
$config['DX_update_view'] = 'auth/update_form';
