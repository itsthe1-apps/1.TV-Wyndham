...
<table width="99%" cellpadding="0" cellspacing="0" style="margin-bottom:8px;">
    <tr>
        ...
        <td align="right" valign="top"><div class="buttons" style="float:right; margin-top:0px;"><a href="<?= base_url() ?>index.php/newsnpromo/menu/add" class="positive"><img src="<?= base_url() ?>images/apply2.png" alt=""/>ADD MENU</a></div></td>
    </tr>
</table>
...
<table border='0' cellspacing='0' cellpadding='3' width='99%' id="table_form">
	<? if (count($newsnpromo_menu) > 0) {
       	foreach ($newsnpromo_menu as $value) {?>
        <tr>
        	<td valign="middle" align="center" width="25%"><img src="<?=$this->config->item('newsnpromo_icon_url').$value->image?>" width="100" height="80"/></td>
        	<td valign="middle" align="center" width="30%"><?=$value->name?></td>
            <td valign="middle" align="center" width="14%">
                	<a href="<?= base_url() ?>index.php/newsnpromo/menu/edit/<?=$value->id ?>"><img src="<?=base_url() ?>images/edit.png" width="16" height="16" border="0" title="Edit"/></a>&nbsp;<a href="javascript:deleteconform('newsnpromo/menu/delete','<?=$value->id ?>','')"><img src="<?=base_url() ?>images/cross.png" width="16" height="16" border="0" title="Delete"/></a>
                </td>
        </tr>
    <? 	}
	}else{?>
