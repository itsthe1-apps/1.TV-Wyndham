    ...
    <body>	
        ...
        <div class="device_details">
            <div class="form-group">
                <label class="group_first_label" for="role"><?php echo form_label('SELECT ROOM GROUP', 'role_name_label'); ?><span class='star'> * </span></label>
                <label class="seperator_char">:</label>
                <?php
                $html_attrs = 'id="role" class="form-control select_form_option"';
                echo form_dropdown('role', $options, '', $html_attrs);
                ?>
...
//echo 'Allowed STB IP (One IP per line) :<br/><br/>';
        ...
        <div class="table_glob">
            <table border='0' cellspacing='0' cellpadding='3' width='99%'>
                ...
                <tr>
                    <td align="left">
                        <br/><div class="main_control_btns" class="buttons" style="margin-top:0px;" > 
                            <button class="btn btn-primary" onClick="history.back();return false;" class="positive">
                                <span class="glyphicon glyphicon-step-backward" style="padding-right:10px;"></span>Back</button>
                            <?php
