...
<div class="device_details">
    <div class="form-group">
        <label class="group_first_label"
               for="role_name_label"><?php echo form_label($this->lang->line('package_channel_name'), 'role_name_label'); ?>
            <span class='star'> * </span></label>
        <label class="seperator_char">:</label>
        <?php
        $html_attrs = 'id="role" class="form-control select_form_option"';
        print form_dropdown('role', $options, $role_id, $html_attrs);
        ?>
