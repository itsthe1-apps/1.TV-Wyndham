...
<h1><? print $title; ?></h1>
<br/>
<table width="100%" cellpadding="5" cellspacing="5" border="0" id="quote" class="table table-bordered table-hover">
    <thead>
        <tr class="success">
    ...
    <tr>
		...
		print form_dropdown('list1[]', $opt_rc, 'class="dropdown-item"', 'size="10", style="width:98%", id="list1" class="form-control", multiple');
		?>
        </td>
        <td align="center">
        <input type="button" name="right3" class="btn btn-primary" value="&gt;&gt;" onclick="listbox_moveacross('list1', 'list2')"/>
        <br/><br/>
        <input type="button" name="left2" class="btn btn-primary" value="&lt;&lt;" onclick="listbox_moveacross('list2', 'list1')"/></td>
        <td align="center" valign="top"><?
		...
		**/
		print form_dropdown('list2[]', $dp_values, $selected_values, 'size="10", style="width:98%", id="list2" class="form-control", multiple');
		?>
        </td>
    </tr> 
    <tr>
        <td  align="center" colspan="3"><?=form_textarea('message', !empty($message['d_msg']) ? $message['d_msg'] : $this->input->post('message'), 'size=25 maxlength=1000 class="form-control" id="message_body"') ?></td>
    </tr>
</table>
        ...
        <td width="20%" align="center"><br/><div class="buttons">
                <button onclick="history.back();return false;" class="btn btn-danger">Back</button>
                    ...
                    if (isset($message['id'])) {
                        ...
                        print '<button type="submit" class="btn btn-primary" name="update">Update Message</button>';
                        //print form_submit('update','Update Skin');
                    } else {
                        print '<button type="submit" class="btn btn-success" name="submit">Send Message</button>';
