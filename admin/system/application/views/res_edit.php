...
<?php
echo form_open_multipart('welcome/res_edit');
...
echo form_upload($data) . "   <img  width='50' src=" . base_url() . "uploads/restaurent/" . $category['icon'] . ">" . "</p>";
/* echo "<p><label for='icon'>Icon</label><br/>";
...
echo form_submit('submit', 'Update Restaurent');
echo form_close();
?>