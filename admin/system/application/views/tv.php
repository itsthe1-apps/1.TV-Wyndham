<table width="99%" cellpadding="0" cellspacing="0" style="margin-bottom:8px;">
	<tr>
        ...
        <td align="right" valign="top"><div class="buttons" style="float:right; margin-top:0px;"><a href="<?=base_url()?>index.php/welcome/addtv" class="positive"><img src="<?=base_url()?>images/apply2.png" alt=""/>ADD TV</a></div></td>
    </tr>
</table>
<?
...
?>
	<tr>
		...
		**/
		?>
        <td valign="middle" align="center"><img  width="50" src="<?=$this->config->item('tv_icon_url')?><? if($file){ print $file;}?>"/></td>
