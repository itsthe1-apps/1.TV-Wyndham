...
$table.='<button type="submit" class="btn btn-success" name="submit"><span class="glyphicon glyphicon-plus-sign" style="padding-right:10px;"></span>Update Genre</button></div></td>';
$table.='</div>';
