...
//$table.="<tr>";
//$table.="<td width='130'><label for='eitxml'>Eit XML</label></td>";
//$table.="<td width='30'>:</td>";
//$table.="<td width='150'>".form_input($data_eitxml,$category['eitXML'])."\nhttp(s):// Required</td>";
//$table.="<td><span id='error'>".form_error('eitxml')."</span></td>";
//$table.="</tr>";

//$table.="<tr>";
//$table.="<td width='130'><label for='epgxml'>Epg XML</label></td>";
//$table.="<td width='30'>:</td>";
//$table.="<td width='150'>".form_input($data_epgxml,$category['epgXML'])."\nhttp(s):// Required</td>";
//$table.="<td><span id='error'>".form_error('epgxml')."</span></td>";
//$table.="</tr>";

$table.="<tr>";
$table.="<td width='130'><label for='path'>Path</label><span class='star'> * </span></td>";
$table.="<td width='30'>:</td>";
$table.="<td width='250'>".form_input($data_path,$category['mrl'])."<b>AMINO:</b>src=igmp://,<b>DUNE:</b>udp://@</td>";
...
//$table.="<tr>";
//$table.="<td width='130' valign='top'><label for='description'>Description</label></td>";
//$table.="<td width='30' valign='top'>:</td>";
//$table.="<td width='250'>".form_textarea($data_description,$category['description'],'maxlength="'.$text_area_length.'" onkeyup="return ismaxlength(this)"')."<br/>(Max length $text_area_length characters)</td>";
