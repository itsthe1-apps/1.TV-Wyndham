...
print form_open('radio/addradiofavourites/'.$channel_id,$attributes);
...
$channel_name = $this->RFavourites->check_channel($channel_id)->row_array();

if(isset($_POST['users']) && !empty($_POST['users'])){
	$is_exist_fav = $this->RFavourites->get_data_id($_POST['users'],$channel_id);
